...
public class LinkedCollection<T> implements CollectionInterface<T>, Iterable<T>
{
  ...
  public Iterator<T> iterator() {
	  ...
	  //checks if the current node.getLine is not null
	  ...
	  public T next() {
	  	if(!hasNext())
	  		throw new IndexOutOfBoundsException("You ran out of items");
	  	else {
	  		T dummy = current.getInfo();
